...
function App() {
  ...
  const getUsers = async () => {
    try {
      const res = await axios.get("https://implantacaosistemasbackend.onrender.com/api/person");
      setList(res.data);
  ...
  const registerUser = async () => {
    try { 
      await axios.post("https://implantacaosistemasbackend.onrender.com/api/person",{
  ...
  const deleteUser = async (id) => {
    try { 
      console.log(id)
      await axios.delete(`https://implantacaosistemasbackend.onrender.com/api/person/${id}`);
      getUsers()
    } catch (error) {
